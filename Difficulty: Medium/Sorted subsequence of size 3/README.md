...
</span><strong style="font-size: 18px;">Explanation: </strong><span style="font-size: 18px;">As 5 &lt; 6 &lt; 30, and they  appear in the same sequence in the array. So output is 1.<br><strong>Input:</strong> arr[] = [1, 2, 3, 4]
